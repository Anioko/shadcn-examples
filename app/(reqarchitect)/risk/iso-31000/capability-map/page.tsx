...
import { iso31000CapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/iso-31000-capability-map'
...
export default function ISO31000CapabilityMapPage() {
  ...
  const handleTypeDescriptionsUpdate = (descriptions: CapabilityTypeDescriptions) => {
    ...
    toast({
      ...
      description: 'Category descriptions have been updated successfully.',
    })
  }
  ...
  const handleSave = () => {
    ...
    toast({
      title: 'Saved',
      description: 'ISO 31000 capability map has been saved successfully.',
    })
  }
  ...
  const handleExportCSV = () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as CSV.',
    })
  }
  ...
  const handleExportTXT = () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as TXT.',
    })
  }
  ...
  const handleExportMarkdown = () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as Markdown.',
    })
  }
  ...
  const handleExportJSON = () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as JSON.',
    })
  }
  ...
  const handleExportExcel = () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as Excel.',
    })
  }
  ...
  const handleExportPNG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as PNG.',
    })
  }
  ...
  const handleExportJPEG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as JPEG.',
    })
  }
  ...
  const handleExportSVG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'ISO 31000 capability map has been exported as SVG.',
    })
  }
    ...
    input.onchange = (e) => {
      ...
      reader.onload = (event) => {
        try {
          ...
          toast({
            title: 'Imported',
            description: 'ISO 31000 capability map has been imported successfully.',
          })
        } catch (error) {
          toast({
            title: 'Import Failed',
  ...
  const handleReset = () => {
    ...
    toast({
      title: 'Reset',
      description: 'ISO 31000 capability map has been reset to default data.',
    })
  }
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">ISO 31000:2018 Risk Management</h1>
          <p className="text-muted-foreground">
            Principles, Framework, and Process for effective risk management
          </p>
        </div>
