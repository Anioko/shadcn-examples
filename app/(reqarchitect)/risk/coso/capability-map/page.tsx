...
import { cosoCapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/coso-capability-map'
...
export default function COSOCapabilityMapPage() {
  ...
  const handleTypeDescriptionsUpdate = (descriptions: CapabilityTypeDescriptions) => {
    ...
    toast({
      ...
      description: 'Component descriptions have been updated successfully.',
    })
  }
  ...
  const handleSave = () => {
    ...
    toast({
      title: 'Saved',
      description: 'COSO capability map has been saved successfully.',
    })
  }
  ...
  const handleExportCSV = () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as CSV.',
    })
  }
  ...
  const handleExportTXT = () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as TXT.',
    })
  }
  ...
  const handleExportMarkdown = () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as Markdown.',
    })
  }
  ...
  const handleExportJSON = () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as JSON.',
    })
  }
  ...
  const handleExportExcel = () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as Excel.',
    })
  }
  ...
  const handleExportPNG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as PNG.',
    })
  }
  ...
  const handleExportJPEG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as JPEG.',
    })
  }
  ...
  const handleExportSVG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'COSO capability map has been exported as SVG.',
    })
  }
    ...
    input.onchange = (e) => {
      ...
      reader.onload = (event) => {
        try {
          ...
          toast({
            title: 'Imported',
            description: 'COSO capability map has been imported successfully.',
          })
        } catch (error) {
          toast({
            title: 'Import Failed',
  ...
  const handleReset = () => {
    ...
    toast({
      title: 'Reset',
      description: 'COSO capability map has been reset to default data.',
    })
  }
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">COSO Internal Control Framework</h1>
          <p className="text-muted-foreground">
            5 Components and 17 Principles for effective internal control systems
          </p>
        </div>
