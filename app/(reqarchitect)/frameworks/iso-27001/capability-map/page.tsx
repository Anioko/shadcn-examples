...
import { iso27001CapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/iso-27001-capability-map'
...
export default function ISO27001CapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">ISO/IEC 27001:2022 Capability Map</h1>
          <p className="text-muted-foreground">
            Manage and visualize information security management capabilities with heat maps and strategic planning
          </p>
        </div>
