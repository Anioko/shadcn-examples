...
import { itil4CapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/itil4-capability-map'
...
export default function itil4CapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">ITIL 4 Service Management Capability Map</h1>
          <p className="text-muted-foreground">
            Manage and visualize IT service management capabilities with heat maps and strategic planning
          </p>
        </div>
