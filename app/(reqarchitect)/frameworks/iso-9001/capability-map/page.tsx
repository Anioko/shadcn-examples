...
import { iso9001CapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/iso-9001-capability-map'
...
export default function ISO9001CapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">ISO 9001:2015 Capability Map</h1>
          <p className="text-muted-foreground">
            Manage and visualize quality management system capabilities with heat maps and strategic planning
          </p>
        </div>
