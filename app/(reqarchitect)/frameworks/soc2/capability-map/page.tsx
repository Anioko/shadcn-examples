...
import { soc2CapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/soc2-capability-map'
...
export default function SOC2CapabilityMapPage() {
  ...
  const handleTypeDescriptionsUpdate = (descriptions: CapabilityTypeDescriptions) => {
    ...
    toast({
      ...
      description: 'Trust Services Criteria descriptions have been updated successfully.',
    })
  }
  ...
  const handleSave = () => {
    ...
    toast({
      title: 'Saved',
      description: 'SOC 2 capability map has been saved successfully.',
    })
  }
  ...
  const handleExportCSV = () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as CSV.',
    })
  }
  ...
  const handleExportTXT = () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as TXT.',
    })
  }
  ...
  const handleExportMarkdown = () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as Markdown.',
    })
  }
  ...
  const handleExportJSON = () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as JSON.',
    })
  }
  ...
  const handleExportExcel = () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as Excel.',
    })
  }
  ...
  const handleExportPNG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as PNG.',
    })
  }
  ...
  const handleExportJPEG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as JPEG.',
    })
  }
  ...
  const handleExportSVG = async () => {
    ...
    toast({
      title: 'Exported',
      description: 'SOC 2 capability map has been exported as SVG.',
    })
  }
    ...
    input.onchange = (e) => {
      ...
      reader.onload = (event) => {
        try {
          ...
          toast({
            title: 'Imported',
            description: 'SOC 2 capability map has been imported successfully.',
          })
        } catch (error) {
          toast({
            title: 'Import Failed',
  ...
  const handleReset = () => {
    ...
    toast({
      title: 'Reset',
      description: 'SOC 2 capability map has been reset to default data.',
    })
  }
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">SOC 2 Type II Capability Map</h1>
