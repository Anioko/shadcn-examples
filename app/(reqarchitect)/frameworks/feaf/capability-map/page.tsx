...
import { feafCapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/feaf-capability-map'
...
export default function FEAFCapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">FEAF Capability Map</h1>
          <p className="text-muted-foreground">
            Manage and visualize Federal Enterprise Architecture capabilities with heat maps and strategic planning
          </p>
        </div>
