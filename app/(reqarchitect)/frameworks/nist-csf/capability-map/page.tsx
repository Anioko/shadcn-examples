...
import { nistCsfCapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/nist-csf-capability-map'
...
export default function nistCsfCapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">NIST Cybersecurity Framework 2.0 Capability Map</h1>
          <p className="text-muted-foreground">
            Manage and visualize cybersecurity risk management capabilities with heat maps and strategic planning
          </p>
        </div>
