...
import { pcfCapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/pcf-capability-map'
...
export default function PCFCapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">Process Classification Framework (PCF) Capability Map</h1>
          <p className="text-muted-foreground">
            Manage and visualize enterprise business process capabilities with heat maps and strategic planning
          </p>
        </div>
