...
import { genaiCapabilityMap as initialCapabilityMap } from '@/lib/data/capability-maps/genai-capability-map'
...
export default function GenAICapabilityMapPage() {
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h1 className="text-4xl font-bold tracking-tight">IBM Gen AI Capability Model</h1>
          <p className="text-muted-foreground">
            Enterprise framework for successful generative AI adoption and deployment
          </p>
        </div>
